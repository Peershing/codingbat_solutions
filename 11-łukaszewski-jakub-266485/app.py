...
CARD_BACK = QImage(os.path.join('imgs', 'back.png'))
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        bg = QBrush(QPixmap(os.path.join('imgs', 'bg.png')))
        self.scene.setBackgroundBrush(bg)

        name = QGraphicsPixmapItem()
        name.setPixmap(QPixmap(os.path.join('imgs', 'signature.png')))
        ...
        deal_action = QAction(QIcon(os.path.join('imgs', 'playing-card.png')), "Deal...", self)
