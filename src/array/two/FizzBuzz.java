...
/*
	...
	"Fizz" instead of the number, for multiples of 5 use "Buzz", and for multiples of both 3 and 5 use
	...
	and index into an array instead of just printing, and we vary the start/end instead of just
	always doing 1..100.
*/
...
public class FizzBuzz {
	public String[] fizzBuzz(int start, int end) {
		...
		for (int i = start; i < end; i++) {
			if (i % 5 == 0 && i % 3 == 0) {
				result = result.append("FizzBuzz ");
		    }
		    else if (i % 5 == 0) {
		    	result = result.append("Buzz ");
		    }
		    else if (i % 3 == 0) {
		    	result = result.append("Fizz ");
		    }
		    else {
