...
class View(object):
    ...
    def __init__(self, main_element):
        ...
        """
        self.window = main_element
        if not main_element.objectName():
            main_element.setObjectName('MainWindow')
        main_element.resize(500, 500)
        main_element.setTabShape(QtWidgets.QTabWidget.Rounded)
        self.centralwidget = QtWidgets.QWidget(main_element)
        ...
        QtCore.QMetaObject.connectSlotsByName(main_element)
    ...
    def rename_successful(self, name):
        messagebox = QtWidgets.QMessageBox(QtWidgets.QMessageBox.Icon.Information,
                                           'Renaming was successful', f'Renamed file to {name}')
        messagebox.exec()
