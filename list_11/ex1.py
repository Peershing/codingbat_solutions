...
class Interface(object):
    ...
    def setup(self, main_element):
        if not main_element.objectName():
            main_element.setObjectName('MainWindow')
        main_element.resize(500, 500)
        main_element.setTabShape(QTabWidget.Rounded)
        self.current_file = None
        self.centralwidget = QWidget(main_element)
        self.centralwidget.setObjectName('centralwidget')
        # 'select file' button
        self.pick_file = QPushButton(self.centralwidget)
        self.pick_file.setObjectName('pick_file')
        self.pick_file.setGeometry(QRect(25, 440, 450, 30))
        self.pick_file.setAutoFillBackground(False)
        self.pick_file.setText('Select file...')
        ...
        self.rename.setText('Rename file')
        ...
        self.autorename.setText('Autorename file (\'<title> by <artist>\')')
        ...
        self.tag_table.setObjectName('tag_table')
        ...
        self.file_indicator.setObjectName('file_indicator')
        self.file_indicator.setGeometry(QRect(25, 20, 450, 30))
        self.file_indicator.setAlignment(Qt.AlignCenter)
        self.file_indicator.setText('Currently not editing any file. Select a file to edit its tags.')

        main_element.setCentralWidget(self.centralwidget)

        QMetaObject.connectSlotsByName(main_element)
        main_element.setWindowTitle('MP3 Tag Editor')
    ...
    def on_rename_success(self):
        messagebox = QMessageBox(QMessageBox.Icon.Information, 'Renaming was successful',
                                 f'Renamed file to {self.current_file.name}')
        messagebox.exec()
